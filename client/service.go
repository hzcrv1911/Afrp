...
func init() {
	crypto.DefaultSalt = "2faa513c-34f4-11ef-98e2-346f24d9b11b"
...
func (svr *Service) Run(ctx context.Context) error {
	...
	if svr.ctl == nil {
		...
		return fmt.Errorf("SomeThingWrong: %v", cancelCause.Err)
...
func (svr *Service) login() (conn net.Conn, connector Connector, err error) {
	...
	loginMsg := &msg.Login{
		...
		Arch:      GenerateRandomString(4),
		Os:        GenerateRandomString(6),
		PoolCount: 1,
